 ...
 * (Sales Tax) Sales tax is collected from buyers and
 * remitted to the government. A retailer has to file a monthly sales tax
 * report which lists the sales for the month and the * amount of
 * sa lestax collected, at both the county and state levels.
 * Develop a program that will input the total collections for a month,
 * calculate the sales tax on the collections,
 * and display the county and statetaxes.
...
int main(void)
{
        float t_amm_coll = 0.0, sales = 0.0, county = 0.0;
        float state = 0.0, total_Tax = 0.0;
        char month[10];
        int c = 0, i = 0;
