...
void menu(short int n)
{
        ...
        case 1:
                ...
                break;
        case 2:
                puts("Which country currently emits the most \
                greenhouse gases?");
                puts("1. Rusia");
                puts("2. EE.UU");
                puts("3. India");
                ...
                break;
        case 3:
                puts("Which of the following lightbulb types uses the least \
                energy, and therefore results in fewer \
                ...
                break;
        case 4:
                puts("How many human deaths per year does the World Health \
                Organization attribute to climate change?");
                puts("1. 100.000");
                puts("2. 75.000");
                puts("3. 150.000");
                puts("4. 1.600.000");
        ...
        case 5:
                puts("Which of the following industries could be negatively \
...
void res(short int correct)
{
        ...
        case 3:
                ...
                puts("https://www.nationalgeographic.com/environment/glob\
                al-warming/global-warming-overview/");
