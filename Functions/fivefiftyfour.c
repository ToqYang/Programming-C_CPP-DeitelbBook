...
/**
 * main - (Computer-Assisted Instruction: Varying the Types of Problems)
 *
 * Return: 0 If is success
*/
int main(void)
{
        int result = 0, num = 0, numeq = 0, count = 0, i = 0;
        int pass = 0, xp = 0, opt = 0;
...
/**
 * optionsAri - Choose the options to the CAI
 * @o: (int) Store the option
 *
 * Return: (int) Operation choosed
*/
int optionsAri(int o)
{
 ...
 * @level: (int) Store the exxperience of the player
 *
 * Return: (int) Result of the number multiplied
*/
int mul(int level)
{
        int num1 = 0, num2 = 0;
...
/**
 * add - Sum two number of one single digit
 * @level: (int) Store the exxperience of the player
 *
 * Return: (int) Result of the number added
*/
int add(int level)
{
        int num1 = 0, num2 = 0;
...
/**
 * res - Substract two number of one single digit
 * @level: (int) Store the exxperience of the player
 *
 * Return: (int) Result of the number substracted
 */
int res(int level)
{
        int num1 = 0, num2 = 0;
